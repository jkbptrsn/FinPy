...
class CapletFloorlet(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        # Caplet.
        self.caplet = cf_hw.Caplet(self.kappa,
                                   self.vol,
                                   self.discount_curve,
                                   self.strike_rate,
                                   self.fixing_idx,
        ...
        self.caplet_pelsser = \
            cf_hw.CapletPelsser(self.kappa,
                                ...
                                option_type="caplet")
        # Floorlet.
        self.floorlet = cf_hw.Caplet(self.kappa,
                                     self.vol,
                                     self.discount_curve,
                                     self.strike_rate,
                                     self.fixing_idx,
    ...
    def test_theta_method_caplet(self):
        ...
        self.assertTrue(max_error < 4.6e-4)
        # Check gamma.
        ...
        self.assertTrue(max_error < 4.9e-3)
        # Check theta.
    ...
    def test_theta_method_caplet_pelsser(self):
        ...
        if print_results:
            print(f"Maximum error of theta: {max_error:2.7f}")
        self.assertTrue(max_error < 2.2e-6)
    ...
    def test_theta_method_floorlet(self):
        ...
        if print_results:
            print(f"Maximum error of theta: {max_error:2.7f}")
        self.assertTrue(max_error < 1.3e-6)
    ...
    def test_theta_method_floorlet_pelsser(self):
        ...
        if print_results:
            print(f"Maximum error of theta: {max_error:2.7f}")
        self.assertTrue(max_error < 1.6e-6)
