...
class BondAnalytical2F(metaclass=abc.ABCMeta):
    """Bond in 2-factor model with closed-form solution."""
    ...
    def fd_setup(self,
        ...
        Args:
            x_grid: Grid in spatial x-dimension.
            y_grid: Grid in spatial y-dimension.
            form: Tri- ("tri") or pentadiagonal ("penta") form. Default
                is tridiagonal.
            equidistant: Is grid equidistant? Default is false.
            theta_value: Determines the specific method:
