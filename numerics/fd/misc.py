...
def norms_2d(vector1: np.ndarray,
    ...
    Args:
        vector1: Solution on grid1.
        vector2: Solution on grid2.
        step_size1: Step size of grid1 (in x- and y-dimension).
        direction: Dimension in which the step size has changed...
        slice_nr: Ratio of number of steps of grid1 and grid2.
    ...
    if direction == "x":
        ...
        raise ValueError("Direction is unknown. Should be x or y.")
    # "Center" norm.
    n_states = diff.shape
