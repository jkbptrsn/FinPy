...
class DouglasRachford2D(base_class.ADI2D):
    """Douglas-Rachford ADI method in 2 dimensions.
    ...
    def propagation(self, dt: float) -> None:
        ...
        for idx in range(self.nstates[1]):
            ...
            rhs[:, idx] = solve_banded(dimension, operator, rhs[:, idx])
        # Second split; right-hand side.
        rhs -= self.theta_parameter * rhs_tmp
